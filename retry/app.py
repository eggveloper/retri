...
class Window(pyglet.window.Window):
    def __init__(self, app):
        ...
        self.renderer = Renderer(
            app._width, app._height, BANK_SIZE, BANK_COUNT, DRAW_COUNT
        )
    ...
    def on_draw(self):
        ...
        self.renderer.render(
            left, bottom, width, height, self.app._palette, self.app._bg_color
        )
...
class App:
    def __init__(
        self, width, height, scale, *, palette=PALETTE, bg_color=0x000000, fps=60
    ):
        self._width = width
        self._height = height
        self._scale = scale
