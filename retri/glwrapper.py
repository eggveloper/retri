...
class GLTexture:
    ...
    def copy_screen(self, x, y, width, height):
        ...
        gl.glCopyTexImage2D(gl.GL_TEXTURE_2D, 0, self.format, x, y, width, height, 0)
    ...
    def _begin(self, i):
        ...
        gl.glTexParameteri(gl.GL_TEXTURE_2D, gl.GL_TEXTURE_MAG_FILTER, self.filter)
...
class GLShader:
    ...
    def begin(self, att: GLAttribute, tex_list: list[GLTexture]):
        self.att = att
